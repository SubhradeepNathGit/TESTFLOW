            ...
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-slate-300/40 border border-slate-100 overflow-hidden"
                    >
                        {/* Top accent bar */}
                        ...
                        <div className="p-8">
                            ...
                            <h3 className="text-xl font-black text-slate-900 mb-1.5">Submit Assessment?</h3>
                            ...
                            <div className="flex gap-3 mb-8">
                                <div className="flex-1 bg-emerald-50 border border-emerald-100 rounded-2xl p-4 text-center">
                                    <p className="text-2xl font-black text-emerald-700">{answered}</p>
                                ...
                                {unanswered > 0 && (
                                    <div className="flex-1 bg-amber-50 border border-amber-100 rounded-2xl p-4 text-center">
                                        <p className="text-2xl font-black text-amber-700">{unanswered}</p>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    onClick={onConfirm}
                                    disabled={isSubmitting}
                                    className="flex-1 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-xs uppercase tracking-wider transition-all active:scale-95 shadow-lg shadow-indigo-100 flex items-center justify-center gap-2 disabled:opacity-70"
                                >
                                    {isSubmitting ? (
...
const TestPlayer = () => {
    ...
    if (loading) return (
        <div className="flex items-center justify-center h-screen bg-[#FDFDFD]">
            <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-sm font-bold text-slate-400">Loading Test Portal…</p>
            </div>
        </div>
    );
    ...
    const qStatusStyles = {
        'answered':        'bg-emerald-500 text-white shadow-sm shadow-emerald-100',
        'marked':          'bg-amber-400 text-white shadow-sm shadow-amber-100',
        'marked-answered': 'bg-violet-600 text-white shadow-sm shadow-violet-100',
        'visited':         'bg-sky-100 text-sky-700 border border-sky-200',
        'not-visited':     'bg-slate-100 text-slate-400 hover:bg-slate-200',
    };
        ...
        <>
            ...
            <div className="flex h-screen bg-[#F8F9FD] overflow-hidden font-sans select-none">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    {/* Header */}
                    <header className="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-6 shadow-[0_1px_0_0_rgba(0,0,0,0.04)] z-10 shrink-0">
                        ...
                        <div className="max-w-3xl w-full mx-auto my-auto">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mb-7">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {marked[currentQuestion._id] && (
                                                <span className="flex items-center gap-1.5 text-[10px] font-black text-amber-600 uppercase tracking-wider bg-amber-50 border border-amber-100 px-2.5 py-1 rounded-full">
                                                    <FiFlag size={10} /> Marked
                                                </span>
                                            )}
                                            <span className="bg-slate-50 border border-slate-100 text-slate-500 px-3 py-1 rounded-full text-xs font-bold">
                                                1.0 Mark
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    {/* Question text */}
                                    <h2 className="text-lg lg:text-xl text-slate-800 font-semibold leading-relaxed mb-8">
                                        ...
                                        {currentQuestion.options.map((option, idx) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <span className={`font-medium text-base transition-colors ${isSelected ? 'text-indigo-900' : 'text-slate-700'}`}>
                                                        {option}
                                                    </span>
                                                    {isSelected && (
                    ...
                    <footer className="bg-white border-t border-slate-100 shrink-0">
                        <div className="flex items-center justify-between gap-3 px-8 py-4">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 text-slate-500 font-bold text-sm hover:text-indigo-600 disabled:opacity-25 disabled:cursor-not-allowed px-4 py-2.5 rounded-xl hover:bg-slate-50 transition-all min-w-[100px]"
                            >
                            ...
                            <div className="flex gap-2.5">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest border-2 border-slate-200 bg-white text-slate-500 hover:bg-slate-50 transition-all active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed"
                                >
                                    <FiX size={13} />
                                    Clear Response
                                </button>
                        ...
                        >
                            ...
                            <div className="px-5 pt-6 pb-4 border-b border-slate-100">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button
                                        ...
                                        className="p-2 hover:bg-slate-50 rounded-xl text-slate-400 lg:hidden transition-all"
                                    >
                                        <FiX size={18} />
                                    </button>
                                </div>
                            ...
                            <div className="px-6 py-4 flex-1">
                                ...
                                <div className="space-y-2.5">
                                    {[
                                        ...
                                        { color: 'bg-sky-100 border border-sky-200', label: 'Visited', textColor: 'text-slate-500' },
                            ...
                            <div className="p-5 border-t border-slate-50">
                                <button
                                    ...
                                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3.5 rounded-2xl font-bold text-sm transition-all shadow-lg shadow-indigo-100 flex items-center justify-center gap-2 active:scale-95"
                                >
                                    <FiSend size={15} />
                                    Submit Assessment
                                </button>
