                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                    <div>
                        ...
                        <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
                            Instructor <span className="text-white/30 font-light">Management</span>
                        </h1>
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-white/[0.04]">
                                    {instructors.length === 0 ? (
                                        ...
                                        <tr key={instructor._id} className="hover:bg-white/[0.02] transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-bold text-white/90 text-sm">{instructor.name}</p>
                                                        <p className="text-xs text-white/40">{instructor.email}</p>
                                                    </div>
                                                </div>
                                            </td>
