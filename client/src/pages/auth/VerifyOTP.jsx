                ...
                <form onSubmit={handleVerify} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full h-[52px] px-4 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.06] rounded-2xl text-center text-3xl font-black tracking-[0.5em] focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none text-slate-900 dark:text-white shadow-sm"
                            placeholder="000000"
                            autoFocus
                        />
                    </div>
